...
class LLMPayloadGenerator:
    def __init__(self, model_endpoint: str = "http://localhost:11434/api/generate", use_mock: bool = True):
        ...
        self._semantic_cache = {
            ...
            "tenant_id": ["admin-tenant", "system-root", "00000000-0000-0000-0000-000000000000"],
    ...
    def _query_local_llm(self, prompt: str) -> str:
        ...
        raise NotImplementedError("Live LLM integration requires a running Ollama service.")

    def generate_contextual_payload(self, schema_parameters: Dict[str, str]) -> Dict[str, Any]:
        """
